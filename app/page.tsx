  ...
  return (
    <main>
      ...
      <section className="section services" id="services">
        ...
        <p className="all-services">Also available: keyword research · competitor analysis · SEO audits · national SEO · website migration SEO</p>
      </section>

      <section className="section thesis" id="about">
        <div className="thesis-copy">
          <span className="section-index light">02 / WHY LOCAL FORGE</span>
          <h2>Traditional agencies<br />move slowly.<br /><em>We don&apos;t.</em></h2>
          <p>Search is changing faster than ever. We built Local Forge Digital for this moment—combining proven SEO fundamentals with AI-enabled speed and smarter execution.</p>
          <a className="button outline" href="#contact">Start a conversation <span>↗</span></a>
        </div>
        <div className="thesis-panel">
          <div className="signal"><span>OLD WAY</span><b>Long timelines</b><b>Disconnected vendors</b><b>Reports without outcomes</b></div>
          <div className="signal active"><span>THE LOCAL FORGE WAY</span><b>Faster execution</b><b>One integrated strategy</b><b>Growth you can measure</b></div>
          <div className="forge-core" aria-hidden="true"><span>SEO</span><span>AI</span><span>WEB</span><strong>GROWTH</strong></div>
        </div>
      </section>

      <section className="section process" id="process">
        <div className="section-heading compact">
          <div><span className="section-index">03 / OUR APPROACH</span><h2>Clarity first.<br /><em>Momentum next.</em></h2></div>
          <p>No bloated retainers or mystery work. Just a clear plan, decisive execution, and a shared focus on the opportunities that matter.</p>
        </div>
      ...
      <section className="section contact" id="contact">
        <div className="contact-copy">
          <span className="section-index light">04 / LET&apos;S GROW</span>
          <h2>Your next lead<br />is already <em>searching.</em></h2>
          <p>Tell us where you want to grow. We&apos;ll show you where the strongest opportunities are hiding—with a free, no-pressure growth audit.</p>
          <div className="contact-note"><span>✓</span> No generic sales deck. Just practical opportunities for your business.</div>
        </div>
        <form className="contact-form" onSubmit={handleSubmit}>
          <label>Name<input required name="name" placeholder="Your name" /></label>
          <label>Work email<input required type="email" name="email" placeholder="you@company.com" /></label>
          <label>Website<input type="url" name="website" placeholder="https://yourwebsite.com" /></label>
          <label>What do you want to improve?<select name="goal" defaultValue=""><option value="" disabled>Select your biggest priority</option><option>Generate more local leads</option><option>Improve organic rankings</option><option>Build a new website</option><option>Optimize for AI search</option><option>Not sure yet</option></select></label>
          <button className="button primary submit" type="submit">Request my free audit <span>↗</span></button>
          {sent && <p className="form-success" role="status">Thanks—your request is ready. Connect this form to your preferred CRM before launch.</p>}
        </form>
      </section>

      <footer>
        <a className="brand footer-brand" href="#top"><span className="brand-mark"><i>L</i><i>F</i></span><span>LOCAL FORGE <b>DIGITAL</b></span></a>
        <p>SEO, AI, and websites built for business growth.</p>
        <div><a href="#services">Services</a><a href="#process">Approach</a><a href="#contact">Contact</a></div>
        <small>© 2026 Local Forge Digital. Built for what&apos;s next.</small>
      </footer>
    </main>
  );
}
